...
import { UtilData, IDCmpFn, winSize } from '../../../../@core/data/util.service';
...
@Component({
  selector: 'work-alert-info',
  templateUrl: './work-alert-info.component.html',
  styleUrls: ['./work-alert-info.component.scss']
})
export class WorkAlertInfoComponent implements OnInit {
  ...
  constructor(private router: Router,
    ...
    protected ref: NbDialogRef<WorkAlertInfoComponent>) {
