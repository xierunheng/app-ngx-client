...
@Component({
  selector: 'process-job-master',
  template: `
    <div echarts [options]="options" class="echart"></div>
  `,
})
export class JobMasterComponent implements AfterViewInit, OnDestroy {
  _hs: IHierarchyScope;
  @Input()
  ...
  init(): void {
    if (this._hs && this._startTime && this._endTime) {
      this.jrService.aggr('directive.workMaster.oid', this._hs, this._startTime, this._endTime).subscribe(items => {
