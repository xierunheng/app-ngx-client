...
@Component({
  selector: 'mes-i-yield-front-side',
  templateUrl: './i-yield-front-side.component.html',
  styleUrls: ['./i-yield-front-side.component.scss']
})
export class IYieldFrontSideComponent implements OnDestroy, OnInit {
private alive = true;
