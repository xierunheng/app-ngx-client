...
@Component({
  selector: 'mes-output-pie-chart',
  template: `
    <div echarts class="echart" [options]="options" (chartInit)="onChartInit($event)" (chartClick)="onChartClick($event)">
  `,
  styleUrls: ['output-back-side.component.scss']
})
export class OutputPieChartComponent implements OnInit, AfterViewInit, OnDestroy {
