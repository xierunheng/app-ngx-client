import {
  Component, HostListener, ViewChild, ElementRef, Input, Output, EventEmitter, AfterViewInit, OnInit, OnChanges,
} from '@angular/core';

const VIEW_BOX_SIZE = 300;

@Component({
  selector: 'mes-emaint-temperature-dragger',
  templateUrl: './emaint-temperature-dragger.component.html',
  styleUrls: ['./emaint-temperature-dragger.component.scss']
})
export class EmaintTemperatureDraggerComponent implements AfterViewInit, OnChanges, OnInit {
@ViewChild('svgRoot') svgRoot: ElementRef;
  ...
  private invalidate(): void {
    this.bottomAngleRad = EmaintTemperatureDraggerComponent.toRad(this.bottomAngle);
    this.calculateVars();
