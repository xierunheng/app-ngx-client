...
@Component({
  ...
  `,
  styleUrls: ['./emaint-qty-chart.component.scss']
})
export class EmaintQtyChartComponent implements AfterViewInit, OnDestroy, OnChanges, OnInit {
  @Input()
