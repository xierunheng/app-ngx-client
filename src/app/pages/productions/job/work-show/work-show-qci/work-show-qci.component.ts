...
@Component({
  selector: 'mes-work-show-qci',
  templateUrl: './work-show-qci.component.html',
  styleUrls: ['./work-show-qci.component.scss']
})
export class WorkShowQciComponent implements OnInit {
	_wreq: IWorkRequest;
	@Input()
